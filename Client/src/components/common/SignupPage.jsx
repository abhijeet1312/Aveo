    ...
    <div className="min-h-screen flex" style={{ backgroundColor: '#f9e8dc' }}>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-md w-full space-y-8">
          ...
          {/* Form Header */}
          <div className="text-center">
            <h2 className="text-3xl font-bold text-amber-900">Join Our Community</h2>
            <p className="mt-2 text-amber-700">
              Create an account and start your sustainable lifestyle journey
            </p>
          </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <User className="w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-amber-600" />
                      <input
                        id="firstName"
                        name="firstName"
                        type="text"
                ...
                <div>
                  ...
                  <div className="relative">
                    <Phone className="w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-amber-600" />
                    <input
                      id="phone"
                      name="phone"
                      type="tel"
                ...
                <div>
                  ...
                  <div className="relative">
                    <MapPin className="w-5 h-5 absolute left-3 top-3 text-amber-600" />
                    <textarea
                      id="address"
                      name="address"
                      rows={3}
                      ...
                      onChange={handleInputChange}
                      className="w-full pl-10 pr-4 py-3 border border-amber-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white/90 text-amber-900 placeholder-amber-600 resize-none"
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        >
          ...
          <div className="relative h-full flex items-center justify-center p-12">
            <div className="text-white max-w-lg">
              <h2 className="text-4xl font-bold mb-6">Start Your Sustainable Lifestyle Today</h2>
              <p className="text-xl mb-8 text-white/90">
                Join thousands of conscious consumers who choose sustainability without compromising on quality.
              </p>
