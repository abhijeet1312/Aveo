...
export const fetchCJProducts = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      //   {
      //     headers: {
      //       "CJ-Access-Token": "ea286d669ad4478cad23a8eecc020f98",
...
const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchCJProducts.rejected, (state, action) => {
        state.loading = false;
...
export const { setActiveCategory, setSearchQuery, filterProducts } = productSlice.actions;
export default productSlice.reducer;
